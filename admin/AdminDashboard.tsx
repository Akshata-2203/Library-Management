      ...
      {isMainDashboard && (
        <main className="max-w-7xl mx-auto py-10 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {navCards.map((card) => (
              <Link key={card.path} to={card.path} className="group bg-white p-6 rounded-4xl border border-slate-100 hover:border-violet-200 hover:shadow-xl transition-all duration-300">
